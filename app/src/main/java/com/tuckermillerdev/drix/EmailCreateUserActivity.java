...
public class EmailCreateUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_create_user);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(EmailCreateUserActivity.this, "Authentication Failed", Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
                    }
                });
    ...
    public void updateUI(FirebaseUser user){
        if(user != null){
            startActivity(new Intent(EmailCreateUserActivity.this, ThreadsActivity.class));
        }
    }
}
